...
2. **Timeline** — chronological key events with timestamps
3. **Root Cause** — how the attacker gained access and caused impact
4. **MITRE ATT&CK Mapping** — for each finding, list tactic, technique name, and technique ID (e.g. T1071.001)
